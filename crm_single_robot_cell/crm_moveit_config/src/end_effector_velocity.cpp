...
#include "crm_moveit_config/msg/end_effector_velocity.hpp" 
...
rclcpp::Publisher<crm_moveit_config::msg::EndEffectorVelocity>::SharedPtr velocity_publisher;
...
void calculateAndPublishEndEffectorVelocity(rclcpp::Node::SharedPtr node) {
    ...
    if (robot_state && joint_model_group) {
        ...
        auto velocity_msg = crm_moveit_config::msg::EndEffectorVelocity();
...
int main(int argc, char** argv) {
    ...
    velocity_publisher = node->create_publisher<crm_moveit_config::msg::EndEffectorVelocity>("end_effector_velocity", 10);
